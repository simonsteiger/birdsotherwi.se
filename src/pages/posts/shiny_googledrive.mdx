...
What a cool idea – a living meta analysis!
...
Have a look at the documentation of `read_sheet()` and the arguments `col_types` and `na` if the default setting doesn't correctly format column types or `NA` values.
